...
class PluginFieldsTicketimprimirInjection extends PluginFieldsTicketimprimir implements PluginDatainjectionInjectionInterface
{
   ...
   **/
   ...
   static function getTypeName($nb = 0) {
      return Ticket::getTypeName() . " - Imprimir";
   }
