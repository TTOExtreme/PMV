   ...
   static function install(Migration $migration, $version) {
      ...
      if (!$DB->tableExists($table)) {
         ...
         $query = "CREATE TABLE IF NOT EXISTS `$table` (
                  ...
                  `caller_php`       VARCHAR(255) DEFAULT NULL,
         ...
         if ($field['type'] === 'header') {
            ...
            switch ($field['type']) {
               ...
               case 'text':
                  ...
                  break;
               case 'openurl':
                  //$html="<a href='javascript: w=window.open(\"/OSti/plugins/fields/files/".$field['default_value']."?id=".$items_id."\");w.print();w.close();'>​​​​​​​​​​​​​​​​​print pdf</a>";
                  $src_open="http://".$_SERVER['HTTP_HOST']."/OSti-DAEV/plugins/fields/files/".$field['default_value']."?id=".$items_id;
                  //return $html;
                  //$html="<script language='javascript' type='text/javascript'>window.setTimeout('window.open('\"/OSti/plugins/fields/files/".$field['default_value']."?id=".$items_id."\"','newsite')',10);</script>";
                  $html="<iframe style='border:none; width:100%; height:60vh;' src='{$src_open}'>";
                  return $html;
                  break;
               case 'url':
                  $value = Html::cleanInputText($value);
