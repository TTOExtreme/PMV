<?php
	...
	function Update(){
		...
		echo "
			<tr><td class='td0'style='width:50px;'><center><b>Nº OS: {$row['id']}</td>
			<td class='td0'><center><b><u>Data:</td>
			<td class='td0'><center><b><u>Responsável:</td>
			<td class='td0'><center><b><u>Emissor:</td>
			<td class='td0'><center><b><u>Prioridade:</td>
			<td class='td0'><center><b><u>Localização:</td></tr>";
			pushPriory(6);
			pushPriory(5);
			pushPriory(4);
			pushPriory(3);
