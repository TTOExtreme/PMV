...
class PluginFieldsTicketfinalizarInjection extends PluginFieldsTicketfinalizar implements PluginDatainjectionInjectionInterface
{
   ...
   **/
   ...
   static function getTypeName($nb = 0) {
      return Ticket::getTypeName() . " - Finalizar";
   }
   ...
   **/
   function getOptions($primary_type='') {
      $searchoptions = PluginFieldsContainer::getAddSearchOptions('Ticket', 2);
