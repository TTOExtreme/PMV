...
class PluginFieldsTicketchamadoInjection extends PluginFieldsTicketchamado implements PluginDatainjectionInjectionInterface
{
   ...
   **/
   ...
   static function getTypeName($nb = 0) {
      return Ticket::getTypeName() . " - Chamado";
   }
