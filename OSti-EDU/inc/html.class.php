...
class Html {
   ...
   **/
   static function includeHeader($title = '', $sector = 'none', $item = 'none', $option = '') {
      ...
      echo "<head><title>OSti - ".$title."</title>";
   ...
   **/
   static function footer($keepDB = false) {
      ...
      echo "<td class='right'>" ."Departamento de TI - Prefeitura Municipal de Valinhos" . "</td>";
      echo "</tr></table></div>";
   ...
   **/
   static function helpFooter() {
      ...
      echo "<div id='footer'>";
      echo "<table width='100%'><tr><td class='right'> Departamento de TI - Prefeitura Municipal de Valinhos";
   ...
   **/
   static function nullFooter() {
      ...
      if (!isCommandLine()) {
         ...
         echo "<div id='footer-login'>Departamento de TI - Prefeitura Municipal de Valinhos"  . "</div>";
         self::loadJavascript();
         echo "</body></html>";
      }
      closeDBConnections();
